...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__()
        self.is_memory_efficient = (
            kwargs["is_memory_efficient"] if "is_memory_efficient" in kwargs else False
        )
...
def deit_tiny(patch_size=16, img_size=[224], pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # )
        checkpoint = download_weights("deit_tiny", patch_size, "supervised")
...
def deit_small(patch_size=16, img_size=[224], pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # )
        checkpoint = download_weights("deit_small", patch_size, "supervised")
        model.load_state_dict(checkpoint)
    return model
...
def vit_base(patch_size=16, img_size=[224], pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        checkpoint = download_weights("vit_base", patch_size, "supervised")
        model.load_state_dict(checkpoint)
    return model
